...
class MainShow(Main):
    '''
    axf_mainshow(trackid,name,img,categoryid,
    brandname,img1,childcid1,productid1,longname1,
    price1,marketprice1,img2,childcid2,productid2,
    longname2,price2,marketprice2,img3,childcid3,
...
class Goods(models.Model):
    ...
    '''
    '''
    /*UPDATE axf_goods SET axf_goods.productimg="/static/img/axf/market/goods1.png" where (axf_goods.id-1)%5=0;*/
    批量修改表中符合某条件的某个属性
    '''
    ...
    categoryid = models.IntegerField(default=1)  # 分类id，级联用
